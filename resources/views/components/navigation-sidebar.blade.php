<nav class="sidebar">
    <aside>
        ...
        <div class="sidebar-menu">
            <div class="sidebar-btn" id="sidebar-btn-1">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" >
                    <path class="sidebar-icon-down"  d="M16.293 9.293 12 13.586 7.707 9.293l-1.414 1.414L12 16.414l5.707-5.707z"></path>
                    <path class="sidebar-icon-up" d="M10.707 17.707 16.414 12l-5.707-5.707-1.414 1.414L13.586 12l-4.293 4.293z"></path>
                </svg>
            </div>
            <ul class="sidebar-dropdown" id="sidebar-menu-1">
                <li>
                    <a href="#">
                ...
                <li>
                    <a href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#181143"><path class="trash-closed" d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg>
                        Eliminar Libro
                    </a> 
                </li>
            </ul>
        ...
        <div class="sidebar-menu">
            <div class="sidebar-btn" id="sidebar-btn-2">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-btn" id="sidebar-btn-3">
...
<script>
    const sidebar_btn_1 = document.querySelector(`#sidebar-btn-1`);
    const sidebar_menu_1 = document.querySelector(`#sidebar-menu-1`);
    sidebar_btn_1.addEventListener('click', function () {
        sidebar_menu_1.classList.toggle('active');
        sidebar_btn_1.classList.toggle('active');
    });

    const sidebar_btn_2 = document.querySelector(`#sidebar-btn-2`);
    const sidebar_menu_2 = document.querySelector(`#sidebar-menu-2`);
    sidebar_btn_2.addEventListener('click', function () {
        sidebar_menu_2.classList.toggle('active');
        sidebar_btn_2.classList.toggle('active');
    });

    const sidebar_btn_3 = document.querySelector(`#sidebar-btn-3`);
    const sidebar_menu_3 = document.querySelector(`#sidebar-menu-3`);
    sidebar_btn_3.addEventListener('click', function () {
        sidebar_menu_3.classList.toggle('active');
        sidebar_btn_3.classList.toggle('active');
    });
</script>